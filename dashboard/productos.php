...
<head>
  ...
  <link rel="stylesheet"
    href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@24,400,0,0&icon_names=grocery" />
</head>
      ...
      <main class="h-full pb-16 overflow-y-auto">
        <div class="container grid px-6 mx-auto">
          ...
          <div x-show="isModalOpen" x-transition:enter="transition ease-out duration-150"
            ...
            x-transition:leave-end="opacity-0"
            class="fixed inset-0 z-30 flex items-end bg-black bg-opacity-50 sm:items-center sm:justify-center overflow-y-auto max-h-96">
            <!-- Modal -->
            <div x-show="isModalOpen" x-transition:enter="transition ease-out duration-150"
                ...
                <form action="..\dashboard\ejemplo_guardar.php" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    <label class="block text-sm">
                      ...
                      <input
                        ...
                        type="text" name="nombre" id="nombre" required placeholder="Ejemplo de Producto"
                        oninput="validateNombre()" maxlength="20" />
                  ...
                  <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    <label class="block text-sm">
                      ...
                      <textarea
                        class="block w-full mt-1 text-sm border-gray-300 dark:text-gray-300 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input"
                        name="descripcion" id="descripcion" required placeholder="Descripción del producto"
                        oninput="validateDescripcion()" maxlength="50"></textarea>
                  ...
                  <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    <label class="block text-sm">
                      ...
                      <input
                        class="block w-full mt-1 text-sm border-gray-300 dark:text-gray-300 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input"
                        type="number" name="precio" id="precio" required step="0.01" placeholder="Precio del producto"
                        oninput="validatePrecio()" maxlength="6" />
                  ...
                  <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    <label class="block text-sm">
                      ...
                      <input
                        class="block w-full mt-1 text-sm border-gray-300 dark:text-gray-300 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input"
                        type="number" name="stock" id="stock" required placeholder="Stock disponible"
                        oninput="validateStock()" maxlength="10" />
                  ...
                  <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    <label class="block text-sm">
                      ...
                      <input
                        class="block w-full mt-1 text-sm border-gray-300 dark:text-gray-300 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input"
                        type="file" name="imagen" id="imagen" accept="image/*" required onchange="validateImagen()" />
          ...
          <div class="w-full mb-8 overflow-hidden rounded-lg shadow-xs">
            <div class="w-full overflow-x-auto">
              ...
              // Consultar productos y sus categorías directamente desde la tabla productos
              $sql = "SELECT id_producto, nombre, descripcion, precio, stock, imagen_url, categoria
        FROM productos";
                        ...
                        <div class="flex items-center text-sm">
                          ...
                          <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                            <img class="object-cover w-full h-full rounded-full"
                              ...
                              alt="Imagen de <?php echo $producto['nombre']; ?>" loading="lazy" />
                            <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
                          </div>
                          <div>
                            <p class="font-semibold"><?php echo $producto['nombre']; ?></p>
